...
<<<<<<< HEAD
        if (!opts.processed && !opts.unprocessed && !opts.ignored) {
            ...
            const [[err1, processed], [err2, unprocessed], [err3, ignored]] = (await multi.exec());
            return {
...
<<<<<<< HEAD
            ...
            let processedCursor, processed, unprocessedCursor, unprocessed, ignoredCursor, ignored;
=======
            let failedCursor;
            if (opts.failed) {
...
<<<<<<< HEAD
            return Object.assign(Object.assign(Object.assign({}, (processedCursor
=======
